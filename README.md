...
- [Calendar Synchronizer](https://steamcommunity.com/sharedfiles/filedetails/?id=3779646468)
  installed as `daynight.dll` and `daynight.ini` in the TesmioLoader plugin folder.
...
2. Download and extract `TesmioClock-1.0.0.zip`, or open the Workshop item folder.
